...
//
//public class DeliveryManagerArchive {
//
...
//        // TODO: Check if route weighting was different for deduped routes
...
//        Iterator<Coordinate> queue = network.breadthFirstQueue(currentNode).iterator();
//
...
////        System.out.println(nodesMap);
//
////        System.out.println(network.getNode(currentNode));
//
////        exit(0);
//
...
//
//        while (queue.hasNext()) {
//            double currentNodeCost = currentNode.getCost();
...
////                network.setCost(node, routeCost + node.getCost());
